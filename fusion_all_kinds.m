...
%                     path2 = ['./test_images/', type, '/',num2str(index),'-2','.jpg'];
                    path2 = fullfile(ir_dir, fileNames{j});
                    path1 = fullfile(vi_dir, fileNames{j}); 
%                     path1 = ['./MyDatasets/', type, '/CT/',num2str(index),'.png'];
%                     path2 = ['./MyDatasets/', type, '/MRI/',num2str(index),'.png'];
                    if is_overlap == 1
                        path_temp = ['./fused_p_s_test/', type ,'/', 'level_', num2str(de_level), '/'];
...
%                         fuse_path = [path_temp, 'fused',num2str(index), '_p_s_level_',num2str(de_level), '_',norm ,'_stride_',num2str(stride),'.png'];
                        fuse_path = [path_temp,fileNames{j}];                        
